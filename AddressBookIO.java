...
public class AddressBookIO {
	...
	public static String getEntriesString() {
		...
		try {
			...
			in = new BufferedReader(new FileReader(addressBookFile));

			// define the string and set a header
			String entriesString = "";
			entriesString = padWithSpaces("Name", COL_WIDTH) + padWithSpaces("Email", COL_WIDTH)
					+ padWithSpaces("Phone", COL_WIDTH) + "\n";

			entriesString += padWithSpaces("------------------", COL_WIDTH)
					+ padWithSpaces("------------------", COL_WIDTH) + padWithSpaces("------------------", COL_WIDTH)
					+ "\n";
			...
			while (line != null) {
				...
				entriesString += padWithSpaces(name, COL_WIDTH) + padWithSpaces(emailAddress, COL_WIDTH)
	...
	public static boolean saveEntry(AddressBookEntry entry) {
		...
		try {
			...
			out = new PrintWriter(new BufferedWriter(new FileWriter(addressBookFile, true)));
	...
	// a private method that creates a blank file if the file doesn't already
	// exist
